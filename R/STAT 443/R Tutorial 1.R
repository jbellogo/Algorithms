...
par(mfrow=c(2,2), mar=c(1,1,1,1)) # Dividing the plotting page into 4 panels
...
# poly() needs to have raw=TRUE passsed to it to give you the classical polynomial fit. the default raw=FALSE gives prthogonal polynomials?
summary(reg2)
